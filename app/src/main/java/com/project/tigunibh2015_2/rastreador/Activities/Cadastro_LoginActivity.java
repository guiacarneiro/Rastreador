...
import com.project.tigunibh2015_2.rastreador.Fragments.CadastroFragment;
import com.project.tigunibh2015_2.rastreador.Fragments.Cadastro_LoginActivityFragment;
import com.project.tigunibh2015_2.rastreador.Modelos.Healthcheck;
import com.project.tigunibh2015_2.rastreador.Fragments.LoginFragment;
...
public class Cadastro_LoginActivity extends AppCompatActivity {
    ...
    HttpRequestTask check;

    @Override
    protected void onPause() {
        super.onPause();
        check.cancel(true); //cancelar a assinc task quando o usuario sai da activity
    }
/* @Override
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        context = this;
        check = (HttpRequestTask) new HttpRequestTask().execute();
